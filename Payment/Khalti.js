...
const Khalti = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Button title={'Pay Via Khalti'} onPress={() => setIsVisible(true)} />
      ...
      <KhatiSdk
        ...
        publicKey={'test_public_key_9e98a97cc46941158f86a0acc99d224b'} // Test or live public key which identifies the merchant
      />
    </SafeAreaView>
  );
};
